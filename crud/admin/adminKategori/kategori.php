                    ...
                    <div class="list-group list-group-flush rounded-0">
                        ...
                        <div class="accordion-item rounded-0">
                            ...
                            <div id="accordionEmpat" class="accordion-collapse collapse" data-bs-parent="#accordioFlush">
                                <div class="accordion-body p-0">
                                    <div class="list-group">
                                        <a href="kategori.php" class="list-group-item list-group-item-action">Kategori</a>
                                        <a href="tambah_kategori.php" class="list-group-item list-group-item-action">Tambah Kategori</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                          ...
                          <tbody>
                            ...
                            <?php foreach ($kategori as $row) : ?>
                                <tr>
                                    ...
                                    <td class="align-middle"><a class= "btn btn-warning text-light" href="edit_kategori.php?id_kategori=<?= $row["id_kategori"]; ?>">Edit</a> <a class= "btn btn-danger text-light" href="hapus_kategori.php?id_kategori=<?= $row["id_kategori"]; ?>">Hapus</a></td>
                                </tr>   
                            <?php $i++; ?> 
                            <?php endforeach;?>
