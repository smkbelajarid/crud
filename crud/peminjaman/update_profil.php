                            ...
                            <div id="accordionSatu" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordioFlush">
                                <div class="accordion-body p-0">
                                    <div class="list-group">
                                        <a href="bukuTerpinjam.php" class="list-group-item list-group-item-action">Buku Terpinjam</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div id="page-content-wrapper">
                ...
                <div class="row">
                  ...
                  <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
                    <div class="col">
                      <h2 class="text-center">Update Data Diri</h2>
                    </div>
                  </div>
                  <!-- judul -->
                  <!-- content -->
                                ...
                                <div class="col-11">
                                    <form action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="username" name="username" value="<?= $siswa["username"]; ?>" autocomplete="off">
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <br><br>
                                            <img src="../asset/img/<?= $siswa['gambar'];?>" width="300">
                                        </div>
